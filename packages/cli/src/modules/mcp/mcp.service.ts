...
export class McpService {
	 ...
	 * Mirrors the front-end telemetry settings (see `FrontendService`): the
	 * RudderStack data plane and source config are reached through the instance's
	 * telemetry proxy, so both URLs are instance-relative. No per-user data is
	 * included, keeping the rendered app HTML cache-safe across users.
	 */
